...
function Dashboard() {
  ...
  /* Open modal and reset form to current user */
  const openEdit = () => {
    setForm({ ...user })
    setErrors({})
    setSaved(false)
      ...
      <div className="dashboard-layout">
        ...
        <main className="dashboard-content">
          ...
          <div className="table-card">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table>
                <thead>
                  <tr>
                    <th>Booking ID</th><th>Package</th><th>Travel Date</th>
                    <th>Travelers</th><th>Amount</th><th>Status</th><th>Action</th>
                  </tr>
                </thead>
                <tbody>
                  {myBookings.map((b) => (
          ...
          <div id="profile" className="profile-card">
            <div className="profile-avatar">{user.firstName ? user.firstName.charAt(0).toUpperCase() : '?'}</div>
