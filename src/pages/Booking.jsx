...
function Booking() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await apiPost('https://travelx-2-2liv.onrender.com/api/bookings', Object.fromEntries(fd), token)
      setStatus('success')
      e.target.reset()
    } catch {
      setStatus('error')
  ...
  return (
    <>
      ...
      <div className="page-header">
        <h1>Book Your <span style={{ color: '#00B4FF' }}>Tour</span></h1>
      ...
      <section className="booking-section">
        ...
        <div className="booking-steps">
          {['Personal Details', 'Tour Selection', 'Payment', 'Confirmation'].map((s, i) => (
        ...
        <div className="booking-grid">
          ...
          <div className="booking-form-box light-form">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <h3 style={{ marginTop: '28px', marginBottom: '20px', fontSize: '18px' }}>Tour Details</h3>
              <div className="form-row2">
                <div className="form-group">
              ...
              <h3 style={{ marginTop: '28px', marginBottom: '20px', fontSize: '18px' }}>Payment Method</h3>
              <div className="payment-options">
                {['💳 Credit / Debit Card', '📱 UPI / BHIM', '🏦 Net Banking', '💰 Pay Later (EMI)'].map((p) => (
                  <label key={p} className="pay-option">
                    <input type="radio" name="payment" defaultChecked={p.includes('Credit')} />
                    {p}
                  </label>
                ))}
              </div>
              ...
              <label className="check-label" style={{ marginBottom: '20px', display: 'flex', color: '#475569' }}>
                ...
                <span style={{ marginLeft: '8px', fontSize: '13px' }}>
                  I agree to the <Link to="/terms" style={{ color: '#00B4FF' }}>Terms</Link> and <Link to="/privacy" style={{ color: '#00B4FF' }}>Privacy Policy</Link>
                </span>
              </label>
          ...
          <div className="booking-summary">
            ...
            <div className="summary-card">
              <img src="https://images.unsplash.com/photo-1519046904884-53103b34b206?q=80&w=600&auto=format&fit=crop" alt="Package" />
              ...
              <div className="summary-price">
                <div className="s-row"><span>Package Price</span><strong>₹25,000</strong></div>
                <div className="s-row"><span>Taxes (18%)</span><strong>₹4,500</strong></div>
                <div className="s-row"><span>Insurance</span><strong>₹500</strong></div>
                <div className="s-divider" />
                <div className="s-row total"><span>Total Amount</span><strong>₹30,000</strong></div>
                <div className="s-row" style={{ fontSize: '13px', color: '#64748b' }}><span>Advance (30%)</span><strong style={{ color: '#16a34a' }}>₹9,000</strong></div>
              </div>
